let yemeksirket = JSON.parse(sessionStorage.yemeksirket || null);
window.onload = () => {
    if(yemeksirket == null){
...
addProductBtn.addEventListener('click', () => {
    ...
    if(productName.innerHTML == productName.getAttribute('data-placeholder')){
    ...
    else if(sirketName.innerHTML == sirketName.getAttribute('data-placeholder') ){
        ...
        sendData('/yemeksirket-ekle', data)
    }
})
...
const productData = () => {
    ...
    return {
        ...
        sirketName:sirketName.innerText,
        tags: tagsArr,
        image: imagePath,
        email: JSON.parse(sessionStorage.yemeksirket).email,
        draft: false
    }
}
...
const setFormData = (data) => {
    ...
    sirketName.innerHTML=data.sirketName;
...
let productId = null;
if(location.pathname != '/yemeksirket-ekle'){
